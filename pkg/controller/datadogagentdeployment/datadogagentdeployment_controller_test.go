	...
	tests := []struct {
		...
		},
		{
			...
			wantFunc: func(c client.Client) error {
				...
				if err := c.Get(context.TODO(), newRequest("bar", SystemProbeConfigMapName).NamespacedName, configmap); err != nil {
					return err
				}
		...
		},
		{
			...
			wantFunc: func(c client.Client) error {
				configmap := &corev1.ConfigMap{}
				if err := c.Get(context.TODO(), newRequest("bar", SystemProbeAgentSecurityConfigMapName).NamespacedName, configmap); err != nil {
					return err
				}
